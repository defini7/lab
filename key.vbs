...
Win10ProductName = "Âåðñèÿ Windows 10: " & WshShell.RegRead(regKey & "ProductName") & vbNewLine
Win10ProductID = "ID ïðîäóêòà: " & WshShell.RegRead(regKey & "ProductID") & vbNewLine
Win10ProductKey = ConvertToKey(DigitalProductId)
ProductKeyLabel ="Êëþ÷ Windows 10: " & Win10ProductKey
